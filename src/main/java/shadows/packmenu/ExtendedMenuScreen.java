...
public class ExtendedMenuScreen extends TitleScreen {
	...
	public static final VariedCubeMap VARIED_CUBE_MAP = new VariedCubeMap(new ResourceLocation("textures/gui/title/background/panorama"));

	protected final PanoramaRenderer panorama = new PanoramaRenderer(VARIED_CUBE_MAP);
