...
public class PackMenuClient {
    ...
    public void load() {
        ...
        Minecraft.getInstance().getResourcePackRepository().addPackFinder(map -> {
            ...
            final Pack packInfo = Pack.create(PackMenu.MODID, Component.literal("Packmenu Builtin"), true, resources, Pack.readPackInfo(PackMenu.MODID, resources), PackType.CLIENT_RESOURCES, Pack.Position.TOP, true,
                PackSource.BUILT_IN);
            if (packInfo == null) {
